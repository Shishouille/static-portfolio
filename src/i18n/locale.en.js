...
export default {
  ...
  about: {
    aboutMe: {
      title: "About Me",
      content:
        ["I'm a 23 years old woman who did a retraining in web development. I left my last life, studying psychology and preparing my Master degree, to find my true calling : Coding. I'm ready to move wherever, if I'm fond of the project and the city is nice to live in.", "I am now looking for a company ready to welcome its new member. You are in front of someone that loves problem solving and challenges. Curious, discovering new concepts is what motivates me, but my ennemy is the routine. Doing the same thing everyday, everytime is not for me in long-term."],
    },
    whyMe: {
      title: "The More you know...",
      content:
      ["Psychology is a background near to my heart in this new domain. But why leave this studies ? I see you coming ! The more time went by, and the more I felt, especially during my internship, that our role was only to put a band aid on someone who got stabbed. It wasn't enough for me, and I wanted to act more in my daily life than in this job.", "Humain stays one of my passions and I want to put my grain of salt in web development because I'm proud of this knowledge that made me grow from in this domain. My studies in university taught me to become autonomous, to search by myself, and to understand. This guidline has been applied to my courses in web development also, and I am still following it to this day."],
    },
    life: {
      studies: [
        {
    ...
    primary: [
      {
        ...
        content: ["ReactJS and Redux are my go-to technologies. I love the state management system, polyvalent enough for not being limited by this tool. Coupled by other libraries as Axios or React-Router, I've developped in team a complete web application at a front-end level : Routing, API calls and UI management with a live information update."],
      },
      {
        icons: [gatsbyIcon, styledComponents],
        title: "JAMStack & Stylisation",
        content:
          ["I really liked the JAMStack concept : They have the pros of static websites speed and are coded with dynamic frameworks.  I have been practicing with GatsbyJS and NextJS for 2 personnal projects. I have experimented routing on NextJS, GraphQL requests on both and 'Images' components that allow a pleasant loading thanks to fragments.", "For stylisation, I love Styled-Components and the concept of CSS-in-JS. Their props system is very practical, global styles and keyframes also. I had the occasion to test Bootstrap during my courses and Tailwind CSS, with its plugins (components in majority) in a personnal project. About SaSS, I see it a lot, and I would be glad to practice it if occasion there is !", "When I am doing a project, I assure there is always a desktop and mobile version with media queries in general, whatever stylisation tool."],
      },
      {
        icons: [bxlNodejs, typescriptIcon],
        title: "New Horizons",
        content:
          ["I would like to know more about Javascript back-end to do fullstack and develop MERN applications. I know how to make a basic CRUD with NodeJS, Express and Mongoose environment. I would like to get better in validation and data manipulation.", "Typescript being trending and allowing more control and verification, I would like to test it soon to adapt my ReactJS components to this new langage."],
      },
    ],
    secondary: [
      {
        ...
        content: ["During my courses, I had the opportunity to discover how to create a Wordpress theme. Their codex is very clear, and there is a lot of tutorials about it. If there is an occasion to pratice on this framework, I'm in !", "I have also the required foundation to create websites in HTML/PHP, CSS and Javascript. I have seen the go-to methods for the web pages creation."
        ],
      },
      {
